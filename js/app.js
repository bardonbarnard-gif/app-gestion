...
const matchTitle =
    (m.location || '').toLowerCase() === 'extérieur'
        ...
        : `${teamName} vs ${m.opponent}`;
const teamColors = {
    u12: 'border-purple-500',
    u13: 'border-indigo-500',
    u14: 'border-sky-500',
    u15: 'border-emerald-500',
    u16: 'border-orange-500',
    u17: 'border-red-500'
};
...
const trophyColor =
    ...
    'bg-slate-600';
return `
                    <div class="p-3.5 rounded-xl border border-l-4 ${borderColor} flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 rounded-lg ${trophyColor} text-white flex items-center justify-center font-extrabold text-sm shadow-sm"><i class="fa-solid fa-trophy"></i></div>
                            <div>
